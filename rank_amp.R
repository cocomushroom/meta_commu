...
OTU_raw<-read.delim("LR3_amp_otutable.txt", sep="\t", header=T)
OTU<-OTU_raw[,2:7]
...
OTU_raw[otu_order_subset,12]
write.table(OTU_raw[otu_order_subset,12], row.names=FALSE, col.names=FALSE, quote=FALSE, sep="\t", "top30_seq_LR3_amp_taxa.txt")
write.table(OTU_raw[otu_order_subset,1], row.names=FALSE, col.names=FALSE, quote=FALSE, sep="\t", "top30_seq_LR3_amp_OTUId.txt")



maxY <- 0.45
png("LR3_amp.png", width=1000, height=900)
par(mar=c(20,8,6,3), font.axis=3)
barplot(t(OTU3[otu_order_subset,]), main="LR3-amp", 
...
maxY <- 0.25
png("LR3_amp_all.png", width=1500, height=900)
par(mar=c(19,8,6,3), font.axis=3)
barplot(t(OTU3[otu_order,]), main="LR3_amp_all", 
...
######
maxY <- 0.25
png("LR3_amp_OTUname.png", width=1000, height=900)
par(mar=c(36,5,3,2), font.axis=3)
barplot(t(OTU3[otu_order_subset,]), main="LR3_amp_OTUname", 
